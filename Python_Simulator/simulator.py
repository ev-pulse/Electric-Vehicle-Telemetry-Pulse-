...
# LOCATION_NORMAL 범위 (lat 37.47~37.62 / lon 126.88~127.12) 완전 커버
_SEOUL_DISTRICTS: list[tuple[float, float, float, float, int, str]] = [
    (37.460, 37.540, 127.015, 127.125, 101, "서울시 강남구"),    # 확장 (남쪽·동쪽)
    (37.458, 37.498, 126.988, 127.070, 102, "서울시 서초구"),    # 확장 (서쪽·동쪽)
    (37.494, 37.542, 127.080, 127.152, 103, "서울시 송파구"),    # 확장
    (37.534, 37.562, 127.080, 127.152, 104, "서울시 강동구"),    # 확장
    (37.508, 37.552, 126.868, 126.948, 105, "서울시 영등포구"),  # 확장
    (37.446, 37.484, 126.864, 126.918, 106, "서울시 구로구"),    # 확장
    (37.448, 37.474, 126.864, 126.908, 107, "서울시 금천구"),    # 확장
    (37.456, 37.524, 126.840, 126.884, 108, "서울시 양천구"),    # 확장
    (37.458, 37.522, 126.875, 127.020, 109, "서울시 관악구"),    # 핵심 확장 (서쪽 gap 제거)
    (37.493, 37.528, 126.902, 126.975, 110, "서울시 동작구"),    # 확장
    (37.498, 37.562, 126.948, 127.025, 111, "서울시 용산구"),    # 확장
    (37.544, 37.582, 126.952, 127.025, 112, "서울시 중구"),      # 확장
    (37.558, 37.608, 126.930, 127.005, 113, "서울시 종로구"),    # 확장
    (37.548, 37.588, 127.012, 127.082, 114, "서울시 성동구"),    # 확장
    (37.522, 37.562, 127.068, 127.108, 115, "서울시 광진구"),    # 확장
    (37.565, 37.615, 127.010, 127.068, 116, "서울시 동대문구"),  # 확장
    (37.572, 37.638, 126.995, 127.058, 117, "서울시 성북구"),    # 확장
    (37.625, 37.668, 127.035, 127.115, 118, "서울시 노원구"),    # 확장
    (37.645, 37.690, 127.012, 127.078, 119, "서울시 도봉구"),    # 확장
    (37.528, 37.595, 126.862, 126.945, 120, "서울시 마포구"),    # 확장 (북쪽)
    (37.565, 37.615, 126.910, 126.978, 121, "서울시 서대문구"),  # 확장
    (37.588, 37.668, 126.870, 126.950, 122, "서울시 은평구"),    # 확장
    (37.575, 37.638, 126.935, 127.008, 123, "서울시 강북구"),    # 확장
    (37.515, 37.578, 126.818, 126.888, 124, "서울시 강서구"),    # 신규 추가
    (37.552, 37.632, 127.048, 127.128, 125, "서울시 중랑구"),    # 신규 추가
]
